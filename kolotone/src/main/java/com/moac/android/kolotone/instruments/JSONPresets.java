...
//					"release", "amp", "filter", "decay" };
            final SharedPreferences mPrefs = c.getSharedPreferences(
              InstrumentActivity.SHARED_PREFERENCES_AUDIO, 0);
	...
	/*
     * I've commented these out for now - PT
	 */

    //	public void showLoadMenu(final Context c, final InstrumentActivity p) {
//		try {
//			final String[] items = getPresetNames(c);
//			if (items == null || items.length <= 0) {
//				AlertDialog.Builder builder = new AlertDialog.Builder(c);
//				builder.setTitle(com.moac.android.kolotone.R.string.preset_load_title_none);
...
//	}
//	
//	public void showSaveMenu(final Context c, final InstrumentActivity p) {
//		try {
//			final String[] items = getPresetNames(c);
//			if (items == null || items.length <= 0) {
//				showSaveAsMenu(c, p);
...
//	
    ...
    private void populateWithDefaults(Context context) {
        SharedPreferences prefs = context.getSharedPreferences(InstrumentActivity.SHARED_PREFERENCES_APPSTUFF, 0);
